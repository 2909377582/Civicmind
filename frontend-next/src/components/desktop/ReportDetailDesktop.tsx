...
import ScoringPointTable from '@/components/shared/ScoringPointTable';
import LogicComparisonView from '@/components/shared/LogicComparisonView';
import PolishedText from '@/components/shared/PolishedText';
import './ReportDetailDesktop.css';

interface ReportDetailDesktopProps {
    result: UserAnswer
    question: Question | null
}

export default function ReportDetailDesktop({ result, question }: ReportDetailDesktopProps) {
    ...
    const handleBack = () => {
        // If we have exam context, maybe go back to exam?
        // But simply "back" is safer. Or to exam list.
        router.back();
    };
                    ...
                    <div className="score-circle">
                        <svg className="score-ring" viewBox="0 0 100 100">
                            ...
                            <circle
                                ...
                                cy="50"
                                r="45"
                                style={{ strokeDasharray: `${scoreRatio * 283} 283` }}
                            />
                        </svg>
                            ...
                            <div className="polish-diff-content">
                                {(gradingResult.ai_feedback?.polished_with_marks || gradingResult.ai_feedback?.polished_version) ? (
                                    <div className="diff-text">
                                        <PolishedText text={gradingResult.ai_feedback?.polished_with_marks || gradingResult.ai_feedback?.polished_version || ''} />
                                    </div>
                                ) : (
                                    <div className="diff-text">
